...
namespace Students
{
    public class Test
    {
        private static void Main()
        {
            ...
            {
                new Student("Petar", "Petrov", 19, 123414, "+359 2 77 888 888", "email@gfg.bg",
                    new List<int> {5, 2, 5, 4}, 2),
                new Student("Milka", "Mitreva", 32, 123513, "0885 999 888", "email@abv.bg", new List<int> {6, 6, 6, 6},
                    3),
                new Student("Krasi", "Angelov", 38, 123613, "0888 902 888", "email@abv.bg", new List<int> {6, 6, 6, 4},
                    2),
                new Student("Dimitar", "Angelov", 38, 123714, "+3592 0888 999 888", "email@abv.bg",
